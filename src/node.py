...
class Node:
    ...
    def __repr__(self):
        return (
            f"Node(endpoint={self.endpoint!r}, "
    ...
    def get_raw_transaction(self, tx_id: str):
        return self.rpc_request("getrawtransaction", [tx_id, True])

    def get_txout_proof(self, tx_id: str, block_hash: str):
        return self.rpc_request("gettxoutproof", [[tx_id], block_hash])

    def verify_txout_proof(self, proof: str):
        return self.rpc_request("verifytxoutproof", [proof])

    def post_tx(self, tx_hex: str):
        return self.rpc_request("sendrawtransaction", [tx_hex])['result']
    ...
    def rpc_request(self, method: str, params):
        ...
        self.bytes_sent += len(json.dumps(request_payload).encode('utf-8'))
        ...
        try:
            ...
            self.bytes_received += sys.getsizeof(response.json())
